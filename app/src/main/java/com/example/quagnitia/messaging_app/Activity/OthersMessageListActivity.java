...
public class OthersMessageListActivity
...
//                    WindowManager.LayoutParams.FLAG_TURN_SCREEN_ON);
            ...
            txtfromshow.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    DatePickerDialog dpd = new DatePickerDialog(OthersMessageListActivity.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
                        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                            try {
                                ...
                                if (txttoshow.getText().toString().equalsIgnoreCase(reportDate)) {
                                    ...
                                    Toast.makeText(OthersMessageListActivity.this, "Select date less than to date.", Toast.LENGTH_SHORT).show();
                                    txtfromshow.setText("  -  -    ");
                                } else {
                                    SimpleDateFormat curFormater = new SimpleDateFormat("yyyy-MM-dd");
                                    Date dateObj = curFormater.parse(reportDate);
                        ...
                        public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                            try {
                                ...
                                if (txtfromshow.getText().toString().equalsIgnoreCase(reportDate)) {
                                    ...
                                    Toast.makeText(OthersMessageListActivity.this, "Select date grater than from date.", Toast.LENGTH_SHORT).show();
                                    txttoshow.setText("  -  -    ");
                                } else {
                                    SimpleDateFormat curFormater = new SimpleDateFormat("yyyy-MM-dd");
                                    Date dateObj = curFormater.parse(reportDate);
            ...
            txtLogOut.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    final Dialog dialog = new Dialog(OthersMessageListActivity.this);
                    ...
                    txtYes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            new Preferences(OthersMessageListActivity.this).clearPreferences();
                            Intent newIntent = new Intent(OthersMessageListActivity.this, MainActivity.class);
...
//                        Toast.makeText(WelcomeActivity.this, "Sign Out...", Toast.LENGTH_SHORT).show();
            ...
            MessageAdaptor sd = new MessageAdaptor(OthersMessageListActivity.this, activepicupList);
    ...
    private void callPickupWS(final String LoadType) {//nikita
        try {
            ...
            if (LoadType.equalsIgnoreCase("start")) {
                relLoad.setVisibility(View.GONE);
                pd.show();
                call = apiService.getSchoolMessage(preferences.getAgentId(OthersMessageListActivity.this), null, "0", fromdate, todate, new Preferences(this).getString("SI"), getToken());
            } else {
                relLoad.setVisibility(View.VISIBLE);
                call = apiService.getSchoolMessage(preferences.getAgentId(OthersMessageListActivity.this), LoadType, "0", fromdate, todate, new Preferences(this).getString("SI"), getToken());
            }
...
//                                    if (!response.body().getMessage().isEmpty()) {
                                    Toast.makeText(OthersMessageListActivity.this, "Invalid session...", Toast.LENGTH_SHORT).show();
//                                    }
                                    new Preferences(OthersMessageListActivity.this).clearPreferences();
                                    Intent newIntent = new Intent(OthersMessageListActivity.this, MainActivity.class);
                                    newIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
