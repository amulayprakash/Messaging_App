...
public class MessageListActivity
    ...
    TextView txtLogOut, txtname, txtschool, txttitle;
//    txtfromshow, txttoshow, txtreset;
//    RecyclerView rvlist;
                ...
                public void onClick(View view) {
                    ...
                    txtYes.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            new com.esf.quagnitia.messaging_app.Storage.Preferences(MessageListActivity.this).clearPreferences();
