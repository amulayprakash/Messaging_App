...
public class SettingsActivity extends AppCompatPreferenceActivity {
     ...
     * esf, 10" tablets are extra-large.
     */
...
//            SwitchPreference vibrateSwitch = (SwitchPreference) findPreference("notifications_new_message_vibrate");
//
...
//            }
//
//            SwitchPreference notiSwitch = (SwitchPreference) findPreference("notifications_new_message");
//
//            if (notiSwitch != null) {
//                notiSwitch.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
//                    @Override
//                    public boolean onPreferenceChange(Preference arg0, Object isVibrateOnObject) {
//                        boolean notiSwitchON = (Boolean) isVibrateOnObject;
//                        if (notiSwitchON) {
////                            Vibrator v = (Vibrator) getActivity().getSystemService(Context.VIBRATOR_SERVICE);
////                            v.vibrate(400);
//                        }else{
...
//            }
//
//            RingtonePreference notiring = (RingtonePreference) findPreference("notifications_new_message_ringtone");
//
//            if (notiring != null) {
//                notiring.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
//                    @Override
//                    public boolean onPreferenceChange(Preference preference, Object o) {
//                        String notiSwitchON = (String) o;
//                        return false;
//                    }
//                });
//
