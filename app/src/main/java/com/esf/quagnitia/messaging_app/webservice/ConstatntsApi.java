...
/**
 * Created by Rahul on 12/7/2018.
 */

public class ConstatntsApi {
//    static final String BASE_URL = "http://rapidxx.com/aqi/api/public/v1/";//old
//    static final String BASE_URL = "http://rapidxx.com/aqi/api/public/test/";//old

    //after new mail from sanket
//    TEST APIs
//    Version 1
